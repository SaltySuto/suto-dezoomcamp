...
#https://nyc-tlc.s3.amazonaws.com/trip+data/fhv_tripdata_2021-04.csv dsa

#https://s3.amazonaws.com/nyc-tlc/trip+data/yellow_tripdata_2021-01.csv
AIRFLOW_HOME = os.environ.get("AIRFLOW_HOME", "/opt/airflow/")
URL_TEMPLATE = 'https://s3.amazonaws.com/nyc-tlc/misc/taxi+_zone_lookup.csv'
OUTPUT_FILE_TEMPLATE = AIRFLOW_HOME + '/output_zones_taxi.csv'
TABLE_NAME_TEMPLATE = 'zones_taxi'
...
def format_to_parquet(src_file):
    ...
    print(f'sourceUris =  f"gs://{BUCKET}/raw/{TABLE_NAME_TEMPLATE}.parquet"')
